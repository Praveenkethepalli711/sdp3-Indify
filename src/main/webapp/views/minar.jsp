        ...
        <div class="hero-content"> 
            ...
            <div class="hero-text"> 
                ...
                <ol class="breadcrumb"> 
                  ...
                  <li class="breadcrumb-item active">Qutub Minar</li> 
                ...
                <div class="row"> 
                    ...
                    <div class="col-md-8"> 
                        ...
                        <div class="project-img"> 
                            ...
                            <img src="assets/img/qt1.jpg" class="img-res" alt=""> 

                        </div><!-- /.project-img --> 

                        <div class="project-img"> 

                            <img src="assets/img/qt2.jpg" class="img-res" alt=""> 

                        </div><!-- /.project-img --> 

                        <div class="project-img"> 

                            <img src="assets/img/qt3.jpg" class="img-res" alt=""> 
                    ...
                    <aside class="col-md-4"> 
                        ...
                        <div class="project-info"> 
                            ...
                            <h4>Qutub Minar, Delhi Overview<h4> 
