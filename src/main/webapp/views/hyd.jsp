        ...
        <div class="hero-content"> 
            ...
            <div class="hero-text"> 
                ...
                <ol class="breadcrumb"> 
                  ...
                  <li class="breadcrumb-item active">Charminar</li> 
                ...
                <div class="row"> 
                    ...
                    <div class="col-md-8"> 
                        ...
                        <div class="project-img"> 
                            ...
                            <img src="assets/img/char2.jpg" class="img-res" alt=""> 

                        </div><!-- /.project-img --> 

                        <div class="project-img"> 

                            <img src="assets/img/char1.jpg" class="img-res" alt=""> 

                        </div><!-- /.project-img --> 

                        <div class="project-img"> 

                            <img src="assets/img/char3.jpg" class="img-res" alt=""> 
                    ...
                    <aside class="col-md-4"> 
                        ...
                        <div class="project-info"> 
                            ...
                            <p>Since the construction of the monument in 1591, Charminar has been synonymous with the culture of Hyderabad standing tall as a reminder of the glorious days of the past era. It is a massive structure which has four minarets which many believe stand for the first four 'khalifas' (Prophets) of Islam. Towards the north of the monument, there are four gateways known as Char Kaman which have been constructed in the cardinal directions. The structure was intended to serve as a Madrasa or a Mosque. In its present form, Charminar, along with Qutub Shahi Tombs and the Golconda Fort, has been added to the 'tentative list' of UNESCO World Heritage Sites.</p> 
