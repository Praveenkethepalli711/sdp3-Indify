...
<body>
	<center><h3>HISTORICAL PLACES</h3></center>
	<!-- Sign up form -->
	<section class="signup">
		<div class="container">
			<div class="signup-content">
				<div class="signup-form">
					<h3 class="form-title">HISTORY FORM </h3>
					<form class="register-form" name="register-form" id="register-form" >
						...
						<div class="form-group">
							...
							<input name="designation" id="designation" placeholder="place" />
							<div class="help-block" id="error_designation"></div>
						</div>
						<div class="form-group">
							
							<input name="fulldetails" id="fulldetails" placeholder="full details" />
							<div class="help-block" id="error_designation"></div>
						</div>
  ...
  <img src="/images/loader.gif" alt="loader" style="width: 130px;height: 100px;" id="loader">
				...
				<div class="signup-image">
					<figure>
						<img src="/images/sign-up.jpg" alt="sing up image">
					</figure>
					<div style="display: flex; justify-content: space-between;">
						<a href="${pageContext.request.contextPath}/employees"
							class="signup-image-link">View ADDED PLACES</a> <a
							href="${pageContext.request.contextPath}/home"
							class="signup-image-link">Go BACK</a>
					</div>
				</div>
			</div>
		</div>
